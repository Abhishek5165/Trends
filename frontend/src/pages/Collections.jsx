  ...
  return (
    <div className='flex flex-col sm:flex-row gap-1 sm:gap-10 pt-10 border-t'>
      ...
      <div className='min-w-60'>
        <p onClick={() => setShowFilters(!showFilter)} className='my-2 text-xl flex items-center cursor-pointer gap-2'>
          <img className={`h-3 sm:hidden ${showFilter ? 'rotate-90' : ''}`} src={assets.dropdown_icon} alt="" />FILTERS</p>
        {/* Category Filter */}
